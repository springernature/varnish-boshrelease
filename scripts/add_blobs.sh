...
bosh add-blob get-pip-23.1.2.py varnish/get-pip-23.1.2.py
bosh add-blob jemalloc-5.3.0.tar.bz2 varnish/jemalloc-5.3.0.tar.bz2
bosh add-blob pcre-8.45.tar.gz varnish/pcre-8.45.tar.gz
bosh add-blob varnish-6.0.13.tgz varnish/varnish-6.0.13.tgz
